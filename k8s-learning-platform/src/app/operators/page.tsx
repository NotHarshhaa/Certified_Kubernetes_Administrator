...
const operatorTopics = [
  {
    ...
    topics: ['CRD Creation', 'Schema Validation', 'Versioning', 'API Extensions'],
  },
  {
    ...
    duration: '1-2 hours',
    difficulty: 'Beginner',
    topics: ['Operator Pattern', 'Control Loop', 'State Management', 'Use Cases'],
  },
  {
    title: 'Prometheus Operator Demo',
